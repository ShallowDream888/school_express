    ...
    <div class="aside list">
      <div class="aside_2 col-12 col-sm-6">
        <div class="aside_row">
          ...
          <router-link v-if="obj[vm.source]" to="obj[vm.url]">
      ...
      <div class="btns_interact col-12 col-sm-6">
        <!-- 收藏按钮 -->
        <b-button v-if="this.$store.state.user.user_id" variant="outline-info" @click="add_collect()">
          <b-icon v-if="check_collected" icon="heart-fill"/>
          <b-icon v-else icon="heart"/>
          <span>收藏</span>
        </b-button>
        <b-button v-else variant="outline-info" @click="$router.push('/account/login')">
          <b-icon v-if="check_collected" icon="heart-fill"/>
          <b-icon v-else icon="heart"/>
          <span>收藏</span>
        </b-button>
