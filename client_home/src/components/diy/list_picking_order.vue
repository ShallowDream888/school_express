<template>
	<div class="diy_home diy_list diy_picking_order" id="diy_picking_order_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/picking_order/details?picking_order_id=' + o['picking_order_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/picking_order/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/picking_order/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
			...
			<table class="diy_table">
				<tr class="diy_row">
						...
						任务佣金
							...
							<th class="diy_title" v-if="$check_field('get','quantity_received')">
						领取数量
					</th>
							<th class="diy_title" v-if="$check_field('get','pickup_code')">
						取货码
					</th>
							<th class="diy_title" v-if="$check_field('get','runner')">
						跑腿用户
					</th>
				...
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						...
						<span>
							...
							<td class="diy_field diy_text" v-if="$check_field('get','pickup_code')">
						<span>
							{{ o["pickup_code"] }}
						</span>
					</td>
							<td class="diy_field diy_uid" v-if="$check_field('get','runner')">
						<span>
