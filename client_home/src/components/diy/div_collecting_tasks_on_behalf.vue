			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/picking_order/edit','add')" @click="to_form('/picking_order/edit')" > 接单 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/collecting_tasks_on_behalf/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/collecting_tasks_on_behalf/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
