<template>
  <div id="diy_collecting_tasks_on_behalf_list" class="diy_home diy_list diy_collecting_tasks_on_behalf">
    <!-- 列表 -->
    <div v-if="show" class="diy_view_list list list-x">
      <router-link v-for="(o, i) in list" :key="i" :to="'/collecting_tasks_on_behalf/details?collecting_tasks_on_behalf_id=' + o['collecting_tasks_on_behalf_id']"
                   class="diy_card goods diy_list_box_wrap">
        <!-- 图片 -->
        <div v-if="imgList.length" class="diy_list_img_box">
          <div v-for="(item,index) in imgList" v-show="$check_field('get',item.name,'/collecting_tasks_on_behalf/details') && +item.is_img_list" :key="item+index"
               class="diy_row">
        ...
        <div class="diy_list_item_box">
          <div v-for="(item,index) in showItemList" :key="item+index" class="diy_list_item_content">
            <div v-if="$check_field('get',item.name,'/collecting_tasks_on_behalf/details') && +item.is_img_list" :class="{[item.name]:true}"
                 class="diy_row">
              <div class="diy_title">
                <span>{{ item.title }}:</span>
              </div>
    ...
    <div v-else class="diy_view_table">
      <table class="diy_table">
        <tr class="diy_row">
          ...
          <th v-if="$check_field('get','item_picture')" class="diy_title">
            物品图片
          </th>
          ...
          <th v-if="$check_field('get','order_quantity')" class="diy_title">
            订单数量
          </th>
        ...
        <tr v-for="(o,i) in list" :key="o+i" class="diy_row">
          ...
          <td v-if="$check_field('get','item_picture')" class="diy_field">
            <img :src="o['item_picture']" class="diy_img"/>
          </td>
          ...
          <td v-if="$check_field('get','order_quantity')" class="diy_field diy_text">
						<span>
							{{ o["order_quantity"] }}
						</span>
          </td>
