<template>
  <div class="div_forum">
    ...
    <div class="content" v-html="obj[vm.content]"></div>
    <div class="aside list">
      <div class="aside_1 col-12">
        <span v-for="o in obj[vm.tag]" class="tag ellipsis_1 mr-1">{{ o }}</span>
      ...
      <div class="btns_add col-12 col-sm-6">
        ...
        <div
            ...
            @click="add_praise()"
        >
          <b-icon class="icon icon_change" icon="hand-thumbs-up"></b-icon
          >
        ...
        <div
            ...
            @click="add_collect()"
        >
          <b-icon class="icon icon_change" icon="heart-fill"></b-icon>
          <span class="word_change">收藏</span>
        </div>
        <div v-else class="collect_btn" @click="add_collect()">
          <b-icon class="icon" icon="heart"></b-icon>
          <span>收藏</span>
        </div>
      </div>
