<template>
  <div id="diy_runner_list" class="diy_home diy_list diy_runner">
    <!-- 列表 -->
    <div v-if="show" class="diy_view_list list list-x">
      <router-link v-for="(o, i) in list" :key="i" :to="'/runner/details?runner_id=' + o['runner_id']"
                   class="diy_card goods diy_list_box_wrap">
        <!-- 图片 -->
        <div v-if="imgList.length" class="diy_list_img_box">
          <div v-for="(item,index) in imgList" v-show="$check_field('get',item.name,'/runner/details') && +item.is_img_list" :key="item+index"
               class="diy_row">
        ...
        <div class="diy_list_item_box">
          <div v-for="(item,index) in showItemList" :key="item+index" class="diy_list_item_content">
            <div v-if="$check_field('get',item.name,'/runner/details') && +item.is_img_list" :class="{[item.name]:true}"
                 class="diy_row">
              <div class="diy_title">
                <span>{{ item.title }}:</span>
              </div>
