      ...
      <div class="row">
        ...
        <div class="col diy_pager_item">
          <nav aria-label="Page navigation example">
            <ul class="pagination">
              <li class="page-item">
                <a :class="{'disabled':page === 1}" class="page-link" href="javascript:void(0)" @click="fluctuate(-1)">
                  {{ prev_name }}
                </a>
              </li>
              <li v-for="i in page_num" v-if="i >= (page-max) && i < (page+max)" :class="{'active': page === i}"
                  class="page-item">
                <a class="page-link" href="javascript:void(0)" @click="to(i)">
                  {{ i }}
                </a>
              </li>
              <li class="page-item">
                <a :class="{'disabled':page === page_num}" class="page-link" href="javascript:void(0)"
                   @click="fluctuate(1)">
                  {{ next_name }}
                </a>
              </li>
