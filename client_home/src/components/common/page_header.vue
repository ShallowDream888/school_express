              ...
              <div class="my_header">
                ...
                <div ref="nav_target" class="nav_list">
                  <ul>
                    ...
                    <li v-for="(o,i) in nav_top" v-if="nav_top && i < top_max" v-bind:key="i">
                    ...
                    <li v-if="nav_top.length > top_max">
                      ...
                      <div v-show="show" class="dropdown">
                        <div v-for="(o,i) in nav_top" v-if="i >= top_max" class="item">
                          <router-link :to="o.path">
                            {{ o.page_title }}
                          </router-link>
                        </div>
                ...
                <div v-if="!user.user_id" class="user">
                  <router-link v-for="(o, i) in not_login_dropdown" :key="i" :to="o.url" class="ml">
                    {{ o.name }}
                  </router-link>
                </div>
                <div v-else ref="my" class="user">
                  ...
                  <div v-show="my_show" class="dropdown">
                    <div v-for="(o,i) in my_nav" class="my_item">
                ...
                <div ref="search" class="search-box">
                  <input v-model.trim="search_val" class="search-txt" placeholder="输入关键词" type="text">
                  <div class="search-btn" @click="submit_search">
                    <svg aria-label="search" class="bi-search b-icon bi" fill="currentColor"
                         focusable="false" height="1em" role="img"
