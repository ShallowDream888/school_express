		...
		<div class="warp">
		    <div class="container">
		        <div class="row">
					...
					<!-- 推荐代领任务模块(开始) -->
		<div class="warp" v-if="$check_action('/collecting_tasks_on_behalf/list', 'get')">
		    <!-- 容器 -->
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                ...
		                <div class="diy_recommend">
		                    ...
		                    <div class="more_box">
		                        <router-link to="/collecting_tasks_on_behalf/list" class="more">
		                            <span>更多</span>
		                        </router-link>
		                    </div>
		                ...
		                <!-- 代领任务推荐列表组件 -->
		                <list_collecting_tasks_on_behalf v-if="show_list_collecting_tasks_on_behalf" :list="list_collecting_tasks_on_behalf" />
		                <div class="overflow-auto" v-else>
		                    <table id="list_diy" role="table" aria-busy="false"
		                           :aria-colcount="fields_collecting_tasks_on_behalf.length"
		                           class="table b-table table-striped table-hover">
		                        <thead>
		                        <tr>
		                        ...
		                        <tbody>
		                        <tr v-for="(o, i) in list_table_collecting_tasks_on_behalf" :key="i" @click="to_details('collecting_tasks_on_behalf',o,'collecting_tasks_on_behalf_id')">
