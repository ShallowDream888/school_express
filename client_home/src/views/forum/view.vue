<template>
  <div id="i_want_to_customize_edit" class="diy_edit page_i_want_to_customize">
    <div class='warp'>
      <div class='container'>
        <div class='row form'>
          <div class="col-12 col-md-12 form_img" style="margin-top: 50px">
            ...
            <!-- 图片 -->
            <input id="img" style="display: none;" title="avatar" type="file"
                   @change="change_file($event.target.files,'img')"/>
            <!-- 修改权限 -->
            <div v-if="form.img" class="diy_field diy_img">
              <label for="img">
                <img :src="$fullUrl(form.img)" style="width: 100px;height: 100px"/>
              </label>
            </div>
            <!-- 添加权限 -->
            <div v-else class="diy_field diy_img">
              <label for="img">
          ...
          <div class="col-12 col-md-12 form_item" style="margin-top: 20px">
            ...
            <div class="diy_field diy_text diy_input">
              <input id="title" v-model="form.title" placeholder="请输入标题" type="text"/>
            </div>
          </div>
          ...
          <div class="col-12 col-md-12 form_item">
            ...
            <!-- 文本 -->
            <div class="diy_field diy_text diy_input">
              <input id="tag" v-model="form.tag" placeholder="请输入标签，多个标签输入|分隔" type="text"/>
            </div>
          </div>
