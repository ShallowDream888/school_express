<template>
  <div id="forum_index" class="page_forum">
    <div v-if="$check_action('/forum/list','get')" class="warp">
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-9">
            <div class="card_forum_list">
              ...
              <div class="search_box">
                ...
                <router-link v-if="user_group == '管理员' || $check_action('/forum/list','add')"
                             class="add_forum" style="margin-left: 10px"
                             to="/forum/view">
                  发布内容
                </router-link>
              </div>
