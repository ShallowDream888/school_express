<template>
  <div class="page_article">
    <div v-if="$check_action('/article/list', 'get')" class="warp">
      <div class="container">
        <div class="row">
    ...
    <div v-if="$check_action('/comment/list', 'get')" class="comments-wrap warp">
      <div class="container">
        <div class="row">
          <!-- 评论区 -->
          <div class="col">
            ...
            <div class="form_editor">
              <div v-show="form_comment.reply_to_id" class="fl ml-3">
                对 <i>{{ respondent }}</i> 回复
              </div>
              <div v-show="form_comment.reply_to_id" class="fr mr-3">
                <b-button
                    size="sm"
