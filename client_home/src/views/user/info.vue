<template>
  <div id="user_info" class="page_user">
    <div class="warp">
      <div class="container">
        <div class="row">
              ...
              <div class="div_info">
                ...
                <div class="content_msg">
                  <div class="left_msg">
                    <div class="figure_avatar">
                      <span>头像：</span>
                      <b-img :src="obj.avatar ? $fullUrl(obj.avatar) : '/img/default.png'"
                             alt="" class="user_avator"
                    ...
                    <div class="nickname">
                      ...
                      <div :style="'display:' + display_input + ';'" class="input_nickname">
                        <input id="nickname" v-model="form.nickname" :focus="focus_input"
                               type="text"/>
                ...
                <div class="right_msg">
                  <div class="change_avatar_box">
                    ...
                    <input id="input_file" title=" " type="file"
                           @change="change_avatar($event.target.files)"/>
                  </div>
