...
<div class="section1">
    ...
    <div class="table">
        <table class="layui-hide" id="runner" lay-filter="runner"></table>
...
<script src="../../js/axios.min.js"></script>
    ...
    layui.use(['element', 'layer', 'util'], function () {
        ...
        let url = BaseUrl + '/api/runner/get_list?like=0'
        ...
        if (user_group == "管理员" || $check_action('/runner/table', 'del') || $check_action('/runner/view', 'del')) {
            deletes.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/runner/table', 'add') || $check_action('/runner/view', 'add')) {
            add.style.display = "block"
        }
        if (user_group == "管理员" || $check_action('/runner/view', 'get') || $check_action('/runner/view', 'set')) {
            detail_flag = true;
        }
 ...
 function open_tip(arr) {
    ...
    ,
        ...
        open_tip(res.result.list);
            ...
            if (user_group == "管理员" || $check_pay('/runner/table')) {
                for (var i = 0; i < res.result.list.length; i++) {
                    res.result.list[i].check_pay = true
                }
            }
            if (user_group == "管理员" || $check_action('/runner/view', 'set') || $check_action('/runner/view', 'get')) {
                for (var i = 0; i < res.result.list.length; i++) {
    ...
    ,
        ...
        table.on('tool(runner)', function (obj) {
            var data = obj.data;
        if (obj.event === 'detail')
        {
        ...
        let resetSelect = []
        //下拉框重置/Reset参数
        fun('runner', BaseUrl + '/api/runner/del', 'runner_id', request, resetName, resetSelect                        , undefined, undefined,true
        )
