...
<div class="section1">
    <!-- 内容主体区域 -->
    <div class="manu comment" style="padding: 15px;">
...
<script>
    ...
    layui.use(['element', 'layer', 'util'], function () {
        ...
        let com_url = sessionStorage.com_url
        ...
        table.render({
            elem: '#comments'
            , url: BaseUrl + '/api/comment/get_list' + com_url + source_id
            , headers: {
                'x-auth-token': token
            }
            ...
            , cols: [[
                ...
                , {
                    ...
                    width: '15%',
                    title: '头像',
                    templet: "<div><img src=" + BaseUrl + '{{d.avatar}}' + "></div>"
                }
                , {
