    ...
    <body>
        <div class="section1">
            ...
            <div class="buts">
                ...
                <button type="button" class="layui-btn layui-btn-normal" id="delete" style="display: none">删除/Del
                </button>
                <a href="./view_add.jsp" type="button" class="layui-btn layui-btn-normal" target="main_self_frame"
                    id="add" style="display: none">新增/Add</a>
        ...
        layui.use(['element', 'layer', 'util'], function () {
            ...
            table.render({
                ...
                , cols: [[
                    ...
                    , {
                        field: 'item_weight', width: 180, title: '手机号', sort: true
                        , templet:
                            ...
                            function (x) {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data) {
                                        ...
                                        if (data.result) {
                                            for (let index = 0; index < data.result.list.length; index++) {
                                                if (x.publishing_users === data.result.list[index].user_id) {
                                                    phone = data.result.list[index].phone
                                                }
                                            }
                                        }
                                    }
                    ...
                    ,
                    {
                        field: 'pay_state', title: '支付状态', sort: true, width: 150
                    }
                    , {
                        field: 'pay_type', title: '支付类型', sort: true, width: 150
                    }
                    , {
                        field: 'create_time',
                        width: '20%',
                ...
                ,
                    ...
                    if (user_group === '管理员' || $check_field('get', 'user_phone', path1)) {
                        // console.log("显示")
                    } else {
                        $("[data-field='user_phone']").css('display', 'none');
                    }
