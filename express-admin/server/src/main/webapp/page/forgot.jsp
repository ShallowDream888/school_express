              ...
              <h1>密码找回/Retrieve password</h1>
                ...
                <form class="layui-form" action="">
                    ...
                    <div id="phone" style="display: none;">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <button type="button" class="layui-btn layui-btn-normal" id="verificare1">发送验证码
                                </button>
                            </div>
                        </div>
                    </div>
                    <div id="email" style="display: none;">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                ...
                                <button type="button" class="layui-btn layui-btn-normal" id="verificare2">发送验证码
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="password" name="title" lay-verify="title" autocomplete="off"
                                   placeholder="新密码"
